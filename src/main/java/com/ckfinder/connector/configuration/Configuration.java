...
public class Configuration implements IConfiguration {
    ...
    public boolean checkIfReloadConfig() throws ConnectorException {
        //2018年4月15日16:51:39 return false 一直不更新，更新请重启服务器
        return false;
        /*File cfgFile;
        String path = FileUtils.getFullPath(xmlFilePath, false, true);
        if (path == null) {
     ...
     */
    @Override
    public final IConfiguration cloneConfiguration(HttpServletRequest request) {
        Configuration configuration = createConfigurationInstance(request);
